...
public class ProductControllerTest {
    ...
    public void createProduct_success() throws Exception {
        ...
        productReq.setProductName("test food product");
        productReq.setCategory(ProductCategory.FOOD);
        productReq.setImageUrl("http://test.com");
        productReq.setPrice(100);
        productReq.setStock(2);

        String json = objectMapper.writeValueAsString(productReq);
